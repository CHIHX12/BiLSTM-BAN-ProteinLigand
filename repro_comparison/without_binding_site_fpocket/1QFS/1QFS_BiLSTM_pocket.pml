# PyMOL Script - 1QFS BiLSTM + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
select orange_in_fp, (protein and resi 175)
...
print "=== 1QFS BiLSTM Predicted Active Site (DBSCAN clusters) ==="
print "BiLSTM attention: 94 residues -> GOLD sphere(s) per spatial cluster"
