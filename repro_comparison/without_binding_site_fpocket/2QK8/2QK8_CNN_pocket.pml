# PyMOL Script - 2QK8 CNN + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
python
MODEL_SEL_WEIGHTS     = {'consensus': 4, 'attn_only': 3}
...
print "=== 2QK8 CNN Predicted Active Site (DBSCAN clusters) ==="
print "CNN attention: 10 residues -> RED sphere(s) per spatial cluster"
