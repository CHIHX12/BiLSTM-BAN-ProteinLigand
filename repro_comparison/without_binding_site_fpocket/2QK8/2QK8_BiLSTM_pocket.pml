# PyMOL Script - 2QK8 BiLSTM + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
# ORANGE: attention 50-75% (2 residues, weight 2)
...
select fpocket_all, (protein and resi 6+7+8+13+15+16+17+18+19+20+21+23+24+25+27+28+29+30+31+32+33+34+37+44+45+46+47+50+51+53+55+56+58+63+64+65+66+78+79+80+96+98+99+100+101+102+103+104+106+107+109+114+116+124+125+129+130+131+132+134+135+136+137+155+158+160)

# ORANGE residues that also overlap fpocket (weight 2 for magenta sphere)
select orange_in_fp, (protein and resi 79)

# YELLOW residues that also overlap fpocket (weight 1 for magenta sphere)
select yellow_in_fp, (protein and resi 16)
...
print "=== 2QK8 BiLSTM Predicted Active Site (DBSCAN clusters) ==="
print "BiLSTM attention: 18 residues -> GOLD sphere(s) per spatial cluster"
