# PyMOL Script - 1AQ1 CNN + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
# ORANGE: attention 50-75% (1 residues, weight 2)
...
select orange_in_fp, (protein and resi 93)

# Inject constants before CGO block
python
MODEL_SEL_WEIGHTS     = {'consensus': 4, 'attn_only': 3, 'attn_orange': 2}
...
print "=== 1AQ1 CNN Predicted Active Site (DBSCAN clusters) ==="
print "CNN attention: 31 residues -> RED sphere(s) per spatial cluster"
