# PyMOL Script - 3NZC CNN + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
print "=== 3NZC CNN Predicted Active Site (DBSCAN clusters) ==="
print "CNN attention: 18 residues -> RED sphere(s) per spatial cluster"
