# PyMOL Script - 1OXG CNN + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
# RED: CNN attention >75% (15 residues, weight 3)
...
# ORANGE: attention 50-75% (3 residues, weight 2)
...
select orange_in_fp, (protein and resi 150)
...
print "=== 1OXG CNN Predicted Active Site (DBSCAN clusters) ==="
print "CNN attention: 19 residues -> RED sphere(s) per spatial cluster"
