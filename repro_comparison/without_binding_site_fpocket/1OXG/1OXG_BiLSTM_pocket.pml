# PyMOL Script - 1OXG BiLSTM + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
# MAGENTA: BiLSTM RED + fpocket (1 residues, weight 4)
select consensus, (protein and resi 10)
color magenta, consensus
show sticks, consensus
# RED: BiLSTM attention >75% (28 residues, weight 3)
...
select fpocket_all, (protein and resi 2+3+4+5+7+8+10+34+38+39+40+57+71+72+76+77+80+82+97+98+99+129+130+131+134+150+151+152+172+174+175+177+189+190+191+192+195+201+202+203+205+207+213+214+215+216+217+218+220+224+225+226+227+228)

# ORANGE residues that also overlap fpocket (weight 2 for magenta sphere)
select orange_in_fp, (protein and resi 2)
...
print "=== 1OXG BiLSTM Predicted Active Site (DBSCAN clusters) ==="
print "BiLSTM attention: 29 residues -> GOLD sphere(s) per spatial cluster"
print "fpocket: 54 residues -> BLUE reference sphere"
