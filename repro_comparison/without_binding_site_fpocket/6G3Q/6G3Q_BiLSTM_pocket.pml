# PyMOL Script - 6G3Q BiLSTM + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
select orange_in_fp, (protein and resi 19+164)

# YELLOW residues that also overlap fpocket (weight 1 for magenta sphere)
select yellow_in_fp, (protein and resi 5+20+165)
...
print "=== 6G3Q BiLSTM Predicted Active Site (DBSCAN clusters) ==="
print "BiLSTM attention: 40 residues -> GOLD sphere(s) per spatial cluster"
