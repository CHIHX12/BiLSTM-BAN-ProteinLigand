# PyMOL Script - 5HLS BiLSTM + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
# YELLOW: attention 25-50% (1 residues, weight 1)
...
select fpocket_all, (protein and resi 44+45+46+47+48+50+79+81+82+83+84+85+86+87+88+91+92+94+97+98+103+104+105+106+108+109+112+113+128+131+132+136+137+139+140+141+142+145+146+147+148+149+151+154)

# ORANGE residues that also overlap fpocket (weight 2 for magenta sphere)
select orange_in_fp, (protein and resi 47)
...
print "=== 5HLS BiLSTM Predicted Active Site (DBSCAN clusters) ==="
print "BiLSTM attention: 23 residues -> GOLD sphere(s) per spatial cluster"
print "fpocket: 44 residues -> BLUE reference sphere"
