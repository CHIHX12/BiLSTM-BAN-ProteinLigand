# PyMOL Script - 1T48 CNN + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
CONSENSUS_SEL_WEIGHTS = {'consensus': 3}
...
print "=== 1T48 CNN Predicted Active Site (DBSCAN clusters) ==="
print "CNN attention: 28 residues -> RED sphere(s) per spatial cluster"
