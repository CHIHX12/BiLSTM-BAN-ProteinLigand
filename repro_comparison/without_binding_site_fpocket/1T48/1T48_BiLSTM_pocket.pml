# PyMOL Script - 1T48 BiLSTM + fpocket  [PREDICTED POCKET SPHERE]
#
# Residue colors:
...
# MAGENTA: BiLSTM RED + fpocket (15 residues, weight 4)
...
# RED: BiLSTM attention >75% (50 residues, weight 3)
...
# YELLOW: attention 25-50% (6 residues, weight 1)
...
select fpocket_all, (protein and resi 1+2+3+73+74+75+78+79+80+145+152+157+158+159+168+169+170+176+178+180+185+186+187+188+189+190+192+193+196+197+200+232+235+236+240+241+242+244+252+256+276+277+278+279+280+281+282+288+289+291+292+293+294+295+296+297+298)

# YELLOW residues that also overlap fpocket (weight 1 for magenta sphere)
select yellow_in_fp, (protein and resi 176+193)

# Inject constants before CGO block
python
MODEL_SEL_WEIGHTS     = {'consensus': 4, 'attn_only': 3, 'attn_yellow': 1}
CONSENSUS_SEL_WEIGHTS = {'consensus': 3, 'yellow_in_fp': 1}
...
print "=== 1T48 BiLSTM Predicted Active Site (DBSCAN clusters) ==="
print "BiLSTM attention: 65 residues -> GOLD sphere(s) per spatial cluster"
print "fpocket: 57 residues -> BLUE reference sphere"
